      ...
      navset_card_tab(
        ...
        nav_panel("Held back",
          div(class = "note mb-2",
              ...
              "Businesses, HOAs and landscaping or trade companies never get this offer, and nor do ",
              "monthly maintenance quotes - they are an ongoing service, not a job waiting on a decision. ",
